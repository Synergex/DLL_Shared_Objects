...
Description:    An example of using Synergy DLL API to call C routines
                in a Windows DLL and a UNIX shared object.

Author:         Steve Ives (Synergex Professional Services Group)

Platforms:      Windows and UNIX

Versions:       Synergy/DE 8.1 or higher

Disclaimer:     This code is supplied as seen and without warranty or
                support, and is used at your own risk. Neither the author
                or Synergex accept any responsability for any loss or
                damage which may result from the use of this code.         
